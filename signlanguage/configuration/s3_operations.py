...
class S3operation:
  ...
  @staticmethod
  def read_object(object_name: str, decode: bool = True, make_readable: bool = True) -> Union[StringIO, str]:
    """
    Method Name: read_object

    Description: This method reads object name with kwargs
  ...
  def get_bucket(self, bucket_name: str) -> Bucket:
    ...
    Description: This method gets bucket object based on bucket name
  ...
  def is_model_present(self, bucket_name: str, s3_model_key: str) -> bool:
    ...
    Description: Validates is model present in s3 bucket or not
  ...
  def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
    ...
    Description: Gets the file object from bucket_name bucket based on filename
  ...
  def load_model(self, model_name: str, bucket_name: str, model_dir: str = None) -> object:
    ...
    Description: Loads the model_name from bucket_name with lwargs
  ...
  def create_folder(self, folder_name: str, bucket_name: str) -> None:
    ...
    Description: Creates a folder name folder in bucket name bucket
  ...
  def upload_file(self, from_filename: str, to_filename: str, bucket_name: str, remove: bool = True) -> None:
    ...
    Description: Upload the from_filename file to bucket_name bucket with to_filename as bucket filename
  ...
  def upload_df_as_csv(self, data_frame: DataFrame, local_filename: str, bucket_filename: str, bucket_name: str) -> None:
    ...
    Description: Upload the df to bucket_filename csv filein bucket_name bucket
  ...
  def get_df_from_object(self, object_: object) -> DataFrame:
    ...
    Description: Gets df from object_name object
